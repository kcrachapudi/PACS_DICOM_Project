...
5. **Decoupled Vault Archival:** The completed study is permanently written to a dedicated database and storage file path partition representing the **PACS Storage Vault**. The temporary JSON worklist token is then wiped to maintain queue hygiene.
